    ...
    <div class="content">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Usuário Criar</li>
            </ol>
        </nav>         
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header ">
                        <h5 class="card-title">Usuário do banco de dados</h5>
                        <p class="card-category">Insira os campos para criar um novo usuário</p>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('database.store.user',request()->id) }}" method="POST">
                            @csrf

                            <div class="row">
                                <div class="col-sm-12 form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                                    <label for="username">Usuário</label>
                                    <input name="username" id="username" type="text" class="form-control mask-name" placeholder="Digite o usuário" value="{{ old('username') }}" autofocus>
